...
def test_unicode_canonical_names_persist_through_postgresql(
    dashboard: Dashboard,
    owner: User,
    storage: FilesystemArtifactStorage,
    logical_name: str,
...
def test_deferred_database_trigger_rejects_incomplete_revision(
    dashboard: Dashboard, owner: User, storage: FilesystemArtifactStorage
) -> None:
    csv_key = storage.generate_key()
    with pytest.raises(IntegrityError, match="exactly one HTML"), transaction.atomic():
...
def test_database_recomputes_artifact_name_keys_for_unicode_uniqueness(
...
def test_critical_postgresql_constraints_and_triggers_are_installed() -> None:
    expected_constraints = {
        ...
        "agora_artifact_logical_name_nfc",
        "agora_artifact_name_key_canonical",
    ...
    expected_indexes = {"agora_artifact_one_html_per_revision"}
    expected_triggers = {
        "agora_revision_complete_check",
        "agora_dashboard_latest_check",
        "agora_revision_latest_check",
        "agora_revision_immutability_guard",
        "agora_artifact_immutability_guard",
        "agora_audit_append_only_guard",
        "agora_dashboard_creation_guard",
        "agora_revision_authorization_guard",
        "agora_reservation_mutation_guard",
    }
